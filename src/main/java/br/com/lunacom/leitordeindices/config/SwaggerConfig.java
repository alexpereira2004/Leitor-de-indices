...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.lunacom.leitordeindices.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Invest Master",
                "Solução para análise de ativos financeiros",
                "Versão 1.0",
                "https://www.investimaster.com.br/terms",
                new Contact("Alex L Pereira", "https://www.investimaster.com.br", "alexpereira2004@gmail.com"),
                "Open",
                "https://www.investimaster.com.br/terms",
